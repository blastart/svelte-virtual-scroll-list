<script>
    ...
    /**
     * @type {import('../lib/index').TypeItemType} [type] - type of the item
     */
    ...
    /** @type {import('../lib/index').TypeResizeFnPassive | undefined | null} */
    ...
    function dispatchSizeChange() {
        ...
        previousSize = size
        /** @type {import('../lib/index').TypeResizeEventDetail} */

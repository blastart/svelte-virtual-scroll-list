...
const get_default_slot_changes = dirty => ({ data: dirty[0] & /*displayItems*/ 4 });
const get_default_slot_context = ctx => ({ data: /*dataItem*/ ctx[39] });
const get_header_slot_changes = dirty => ({ data: dirty[0] & /*displayItems*/ 4 });
const get_header_slot_context = ctx => ({ data: /*dataItem*/ ctx[39] });
...
function create_if_block_1(ctx) {
	...
	item.$on("resize", /*onItemResized*/ ctx[6]);
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*$$scope, displayItems*/ 536870916) {
...
// (272:12) <Item                     on:resize={onItemResized}                     uniqueKey={dataItem[key]}                     horizontal={isHorizontal}                     type="item">
...
// (271:8) {#each displayItems as dataItem (dataItem[key])}
function create_each_block$3(key_2, ctx) {
	...
	item = new Item({
			props: {
				uniqueKey: /*dataItem*/ ctx[39][/*key*/ ctx[0]],
	...
	return {
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			const item_changes = {};
			if (dirty[0] & /*displayItems, key*/ 5) item_changes.uniqueKey = /*dataItem*/ ctx[39][/*key*/ ctx[0]];
...
function create_fragment$7(ctx) {
	...
	let mounted;
	let dispose;
	let if_block0 = /*$$slots*/ ctx[8].header && create_if_block_1(ctx);
	let each_value = /*displayItems*/ ctx[2];
	const get_key = ctx => /*dataItem*/ ctx[39][/*key*/ ctx[0]];
	...
	let if_block1 = /*$$slots*/ ctx[8].footer && create_if_block(ctx);
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(div2, "scroll", /*onScroll*/ ctx[7]);
				mounted = true;
			}
		},
		p(ctx, dirty) {
			...
			if (dirty[0] & /*displayItems, key, isHorizontal, onItemResized, $$scope*/ 536870983) {
				each_value = /*displayItems*/ ctx[2];
				group_outros();
			...
			if (!current || dirty[0] & /*paddingStyle*/ 8) {
				set_style(div0, "padding", /*paddingStyle*/ ctx[3]);
			}
...
function instance$7($$self, $$props, $$invalidate) {
	...
	function scrollToOffset(offset) {
		if (pageMode) {
			...
			$$invalidate(4, root[directionKey] = offset, root);
		}
	}
	...
	function onRangeChanged(range_) {
		...
		$$invalidate(3, paddingStyle = $$invalidate(3, paddingStyle = isHorizontal
